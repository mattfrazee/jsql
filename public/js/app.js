...
/* harmony import */ var _jsql__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./jsql */ "./resources/js/jsql.js");
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js");


window.jSQL = _jsql__WEBPACK_IMPORTED_MODULE_0__.jSQL;
var jsonArray = [{
  name: 'John',
  gender: 'male',
  age: 45
...
if (document.getElementById('resultVar') && document.getElementById('resultDemo')) {
  ...
  document.getElementById('resultDemo').innerHTML = '// result:\n' + JSON.stringify(jsonArray.SELECT(['name', 'gender', 'age']).WHERE(function (person) {
    return person.gender === 'male';
  }).ORDER_BY('name', 'ASC'), null, 4);
}
...
/* harmony export */   "jSQL": () => (/* binding */ jSQL)
/* harmony export */ });
...
var jSQL = {
  ...
  COMPARE_BY_STR: function COMPARE_BY_STR() {
  ...
  COMPARE_BY_NUM: function COMPARE_BY_NUM() {
...
Array.prototype.SELECT = function (key) {
  return !key || key === '*' ? this : this.map(function (item) {
    if (Array.isArray(key)) {
      ...
      return obj;
    } else return _defineProperty({}, key, item[key]);
  });
};
...
Array.prototype.LIKE = function () {
  ...
  function searchObject(obj, str) {
    ...
    for (prop in obj) {
      ...
      } else if (typeof obj[prop] === 'string' || typeof obj[prop] === 'number') if (String(obj[prop]).indexOf(String(str)) > -1) found.push(String(obj[prop]).indexOf(String(str))); // console.log(typeof(obj[prop]) === 'string',  typeof(obj[prop]) === 'number', String(obj[prop]).indexOf(String(str)) > -1);
  ...
  this.forEach(function (item, id) {
    if (searchObject(item, searchTerm)) result.push(item);
  });
  return result;
};
...
Array.prototype.LIMIT = function () {
  ...
  var rowCount = arguments.length > 1 ? arguments[1] : undefined;
...
Array.prototype.ORDER_BY = function (key) {
...
Array.prototype.PAGINATE = function () {
  var resultsPerPage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1000;
